...
type Summary = { reconciled:boolean; original_trip_amount_cents:number; adjustments_cents:number; final_trip_total_cents:number; amount_paid_cents:number; refunds_credits_cents:number; deposit_authorized_cents:number; deposit_captured_cents:number; deposit_released_cents:number; deposit_refunded_cents:number; net_deposit_retained_cents:number; balance_cents:number; deposit_settled:boolean };
